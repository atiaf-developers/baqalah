    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form"  id="addEditClientsForm"  enctype="multipart/form-data">
                    {{ csrf_field() }}
...
<div class = "panel panel-default">
    ...
    <div class = "panel-body">
        ...
        <div id="famous-table" class="table-container">
            <a class = "btn btn-sm btn-info pull-left" style = "margin-bottom: 40px;" href = "" onclick = "Clients.add(); return false;" > {{_lang('app.add_new')}} </a>
