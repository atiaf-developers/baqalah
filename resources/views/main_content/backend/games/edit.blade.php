        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                ...
                <div class="col-md-9">
                    ...
                    @foreach ($languages as $key => $value)
                    <div class="form-group form-md-line-input col-md-6">
                        <textarea class="form-control" id="description[{{ $key }}]" name="description[{{ $key }}]" cols="20" rows="30">{{$translations[$key]->description}}</textarea>
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group form-md-line-input">
                        <input type="text" class="form-control" id="discount_price" name="discount_price" value="{{$game->discount_price}}">
                        <label for="discount_price">{{_lang('app.discount_price') }}</label>
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group form-md-line-input">
                        <input type="text" class="form-control" id="over_price" name="over_price" value="{{$game->over_price}}">
                        <label for="over_price">{{_lang('app.over_price') }}</label>
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group form-md-line-input">
                        <input type="number" class="form-control" id="category_order" name="category_order" value="{{$game->category_order}}">
                        <label for="category_order">{{_lang('app.category_order') }}</label>
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group form-md-line-input">
                        <input type="number" class="form-control" id="offers_order" name="offers_order" value="{{$game->offers_order}}">
                        <label for="offers_order">{{_lang('app.offers_order') }}</label>
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group form-md-line-input">
                        <input type="number" class="form-control" id="best_order" name="best_order" value="{{$game->best_order}}">
                        <label for="best_order">{{_lang('app.best_order') }}</label>
                        <span class="help-block"></span>
                    </div>
                    <div class="form-group form-md-line-input">
                        <select class="form-control edited" id="active" name="active">
                            <option {{$game->active==1?'selected':''}} value="1">{{ _lang('app.active') }}</option>
                            <option {{$game->active==0?'selected':''}} value="0">{{ _lang('app.not_active') }}</option>
                        </select>
                    ...
                    <div class="form-group form-md-line-input">
                        <select class="form-control" id="category" name="category">
                            ...
                            <option {{$value->id==$game->category_id?'selected':''}} value = "{{$value->id}}">{{$value->title}}</option>
                            @endforeach
                        </select>
        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                ...
                <div class="form-group form-md-line-input col-md-12">
                    <input type="hidden" name="youtube_url" id="youtube_url" value="{{$game->youtube_url}}">
                ...
                <div id="youtube-iframe" class="col-md-12">
                    <iframe width="100%" height="315" src="//www.youtube.com/embed/{{$game->youtube_url}}" frameborder="0" allowfullscreen></iframe>
                </div>
            ...
            <div class="form-body">
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="image_one_box">
                        <img src="{{url('public/uploads/games').'/'.$game->gallery[0]}}" width="100" height="80" class="image_one" />
                    </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="image_two_box">
                        <img src="{{url('public/uploads/games').'/'.$game->gallery[1]}}" width="100" height="80" class="image_two" />
                    </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="image_three_box">
                        <img src="{{url('public/uploads/games').'/'.$game->gallery[2]}}" width="100" height="80"class="image_three" />
                    </div>
