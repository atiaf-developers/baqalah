...
var Stores = function() {
    ...
    var handleRecords = function() {
        ...
        Stores_grid = $('.dataTable').dataTable({
            //"processing": true,
            "serverSide": true,
            "ajax": {
                "url": config.admin_url + "/stores/data",
                "type": "POST",
