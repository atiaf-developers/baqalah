...
//        })
        ...
        , s = function () {
            function e(e) {
                if (!e.id)
                    return e.text;
                var r = $('<span><img src="' + config.base_url + '/assets/admin/images/flags/' + e.element.value.toLowerCase() + '.png" class="img-flag" /> ' + e.text + "</span>");
                return r
            }
        ...
        return {
            init: function () {
                e(),
                        r(),
                        s(),
                        $.backstretch([config.base_url + "assets/admin/images/bg/1.jpg", "../assets/admin/images/bg/2.jpg", "../assets/admin/images/bg/3.jpg", "../assets/admin/images/bg/4.jpg"], {
                            fade: 1e3,
                            duration: 8e3
                        })
            }
